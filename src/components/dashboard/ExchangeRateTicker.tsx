  ...
  return (
    <section className="space-y-3">
      <div className="text-xs">
        <p className="font-medium text-[#3F465E]">Jan 14, 2026 Exchange Rates:</p>
      ...
      <div className="flex flex-wrap items-center gap-2">
        {rates.map((rate) => (
          <div
            key={rate.code}
            className="inline-flex items-center gap-2 rounded-full border border-[#E9ECF4] bg-white px-3 py-1.5 text-xs text-[#4D556C]"
          >
