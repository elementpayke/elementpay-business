  ...
  return (
    <section className="space-y-6">
      <div className="border-b border-border pb-5">
        <h1 className="text-[28px] font-semibold tracking-[-0.04em] text-foreground">{title}</h1>
      </div>
      ...
      <div className={cardClassName("flex min-h-[280px] flex-col justify-between p-8")}>
        <div>
          ...
          <h2 className="mt-4 text-[30px] font-semibold tracking-[-0.04em] text-foreground">{title} workspace</h2>
          <p className="mt-3 max-w-[520px] text-sm leading-6 text-foreground-muted">{description}</p>
        </div>
